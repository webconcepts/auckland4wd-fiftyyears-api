...
class UpdatePhotoOrderTest extends TestCase
{
    ...
    public function increments_number_for_all_photos_in_same_album_with_equal_or_higher_number()
    {
        ...
        $photo1 = factory(Photo::class)->create(['item_id' => $album->id, 'number' => 1]);
        $photo2 = factory(Photo::class)->create(['item_id' => $album->id, 'number' => 2]);
        $photo3 = factory(Photo::class)->create(['item_id' => $album->id, 'number' => 3]);
        $photo4 = factory(Photo::class)->create(['item_id' => $album->id, 'number' => 4]);
        $photo5 = factory(Photo::class)->create(['item_id' => $album->id, 'number' => 5]);
