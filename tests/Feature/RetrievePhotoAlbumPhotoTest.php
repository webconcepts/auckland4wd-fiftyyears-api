...
class RetrievePhotoAlbumPhotoTest extends TestCase
{
    use DatabaseMigrations;

    /** @test **/
    public function can_retrieve_a_photo_for_a_published_photo_album()
    {
        ...
        $this->json('GET', '/photo-albums/'.$album->obfuscatedId().'/photos/'.$photo->obfuscatedId());
    ...
    /** @test **/
    public function cannot_retrieve_a_photo_in_a_draft_photo_album()
    {
    ...
    /** @test **/
    public function can_retrieve_a_list_of_photos_in_a_published_photo_album_in_number_order()
    {
        $album = factory(Item::class)->states('album', 'published')->create();
        ...
        $this->json('GET', '/photo-albums/'.$album->obfuscatedId().'/photos');
